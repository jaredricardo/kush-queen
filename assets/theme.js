...
slate.Variants = (function() {
  ...
  Variants.prototype = _.assignIn({}, Variants.prototype, {
    ...
    _onSelectChange: function() {
      ...
      this._updateVariantOption(variant);
    ...
    _updateVariantOption: function(variant) {
      // Assuming variant.id holds the value you want to select
      var variantId = variant.id;

        // Check if the select element with the name "id" exists
        var selectElement = document.querySelector('select[name="id"]');
        
        if (selectElement) {
            // Loop through the options if the element exists
        ...
        //Trigger a change for any script that is listening
  ...
  Product.prototype = _.assignIn({}, Product.prototype, {
    ...
    _updateAddToCart: function(evt) {
      ...
      if(!variant.available) {
        if(document.querySelector('#BuyThree') !== null) {
          document.querySelector('#BuyThree').style.display = 'none';
        } 
      } else {
        if(document.querySelector('#BuyThree') !== null) {
          document.querySelector('#BuyThree').style.display = 'block';
        }
      }
      console.log(variant)
      if (variant) {
